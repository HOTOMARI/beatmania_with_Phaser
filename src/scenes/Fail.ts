...
export default class Failed extends Phaser.Scene
{
    ...
    create(){
        ...
        this.background = this.add.tileSprite(0,0,1280,720,'bg_result_fail').setOrigin(0)
        this.add.image(640,360,'overlay_result_fail')
